...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="fable-5-brain", description="Operate Fable 5 Brain.")
    sub = parser.add_subparsers(dest="command", required=True)
    p_new = sub.add_parser("new")
    p_new.add_argument("client")
    p_new.add_argument("--client-name", default="")
    p_new.add_argument("--owner", default="DA")
    p_new.add_argument("--out-dir", default="~/fable-5-brain-vaults")
