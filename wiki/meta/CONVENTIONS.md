...
Filenames Title Case and unique vault-wide; folders lowercase; wikilinks are path-less, like `[[Start Here]]`, except hubs, which may be linked with a full path like `[[wiki/meta/CONVENTIONS|CONVENTIONS]]` when a cross-folder link is ambiguous. Tags lowercase hierarchical per [[Tag Taxonomy]]. No em dashes anywhere.
